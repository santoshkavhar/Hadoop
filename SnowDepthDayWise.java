...
public class SnowDepthDayWise {
  ...
  public static class TokenizerMapper
    ...
    public void map(Object key, Text value, Context context
		...
		// check for "-"
		context.write(new Text(mdata[0].substring(0,2) +"\t"+ mdata[1].substring(6,8) + "\t"+ mdata[1].substring(4,6) + "\t"+ mdata[1].substring(0,4)), new IntWritable(Integer.parseInt(mdata[3])));
...
public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(SnowDepthDayWise.class);
